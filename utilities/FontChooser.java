...
/**
 * The <code>FontChooser</code> class is a swing component for font
 * selection. This class has <code>JFileChooser</code> like APIs. The following
 code pops up a font chooser dialog.

 FontChooser fontChooser = new FontChooser(); int result =
 fontChooser.showDialog(parent); if (result == FontChooser.OK_OPTION) {
 Font font = fontChooser.getSelectedFont(); System.out.println("Selected Font
 : " + font); }
 *
 *
 */
public final class FontChooser extends JComponent {
    ...
    /* CLASSES ______________________________________________________________ */
    ...
    protected class DialogRestoreAction extends AbstractAction {
        ...
        protected static final String ACTION_NAME = "Restore";

        protected DialogRestoreAction() {
            putValue(Action.DEFAULT, ACTION_NAME);
            putValue(Action.ACTION_COMMAND_KEY, ACTION_NAME);
            putValue(Action.NAME, ACTION_NAME);
        }
    ...
    protected JDialog createDialog(Component parent) {
        ...
        Action restoreAction = new DialogRestoreAction();
        ...
        restoreButton.setFont(DEFAULT_FONT);
